...
2. `cd my-lineman-app`
3. `sudo npm install -g lineman bower`
...
Add the following `concat_sourcemap` block to `config/application.coffee` if you want to define your app module in coffeescript:
